...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var rows = Math.floor(window.screen.height / 300); //1 row of pizzas per 300px screen height
  var numPizzas = cols * rows;
  var s = 256;
  var elem; //moved elem declaration outside of loop
  // Changed from querySelector to getElementById and moved outside of loop
